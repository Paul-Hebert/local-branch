			...
			<form id="contact_form" class="add-a-plant" method="POST" action="assets/php/submit_contact.php">
				...
				<section>
					<fieldset>
						...
						<input type="text" name="plant_name" placeholder="California Poppy" class="required">
					</fieldset>
					...
					<fieldset>
						<label for='description'>Counties:</label>
						<textarea name="counties" rows="5" placeholder="Butte, Tehama, Yolo, Glenn"></textarea>
					</fieldset>	
