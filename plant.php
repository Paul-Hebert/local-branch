...
?>
		<div class="main-content">
			...
			<?php 
				echo '<a class="button" id="favorite" data-id="' . $id . '">Favorite</a>';
				...
				for ($count = 0; $count <= 3; $count++){
					if ( $count == $id ){
						...
						echo '<a href="plant.php?id=' . $count . '" class="image_wrapper more_plants"><img src="assets/imgs/plants/' . $plants[$count][2] .'" class="' . $plants[$count][3] . '"></a>';
					}
				}
			?>
